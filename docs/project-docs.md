...
**File:** `components/LightsOutGame.tsx`
...
An icon component that uses native SFSymbols on iOS, and MaterialIcons on Android and web. This ensures a consistent look across platforms, and optimal resource usage.Icon `name`s are based on SFSymbols and require manual mapping to MaterialIcons.
